...
cmake -DCMAKE_C_COMPILE="/usr/bin/gcc-9" -DCMAKE_CXX_COMPILER="/usr/bin/g++-9" -DCMAKE_BUILD_TYPE=Release -DLAF_BACKEND=skia -DSKIA_DIR=$workdir/skia -DSKIA_LIBRARY_DIR=$workdir/skia/out/Release-x64 -G Ninja ..
